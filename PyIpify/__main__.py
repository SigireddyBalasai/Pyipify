...
parser = argparse.ArgumentParser(description="The program to find the ipv4 and ipv6 address of the system.")
...
parser.add_argument("-v", "--version", choices=["ipv4", "ipv6"],
                    ...
                    default="ipv4")
parser.add_argument("-a", "--asynchronous", help="Use this flag to run the program asynchronously", action="store_true",
                    default=False)
